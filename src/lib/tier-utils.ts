...
// NOTE: Professional/Organization (B2B) seat pricing lives in
// src/lib/org-licensing.ts (SEAT_PRICE_LADDER: $89/seat at 1 seat → $49/seat
// at 5+, MIN_SEATS=1, 15% annual discount). A stale PROFESSIONAL_TIERS table
// here contradicted it and was unused — deleted. Do not re-add seat prices here.
