    ...
    <div className="border-b border-gray-100 last:border-0 py-4">
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        {review.author.verified && (
          <span className="flex items-center gap-1 text-xs text-teal-600 bg-teal-50 px-2 py-1 rounded-full">
      ...
      {review.content.length > 200 && (
        <button
          ...
          className="text-teal-600 text-sm font-medium mt-1 flex items-center gap-1"
        >
        ...
        <div className="mt-3">
          ...
          <AnimatePresence>
            {showResponse && (
              ...
              >
                <div className="mt-2 ml-6 p-3 bg-gray-50 rounded-lg border-l-2 border-teal-500">
                  <p className="text-sm text-gray-700">{review.providerResponse.content}</p>
...
export function ProviderReviews({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
                ...
                {[5, 4, 3, 2, 1].map((stars) => (
                  <button
                    ...
                    className={`w-full transition-colors rounded ${
                      filterRating === stars ? 'bg-amber-50' : 'hover:bg-gray-50'
                    }`}
                  >
                    <RatingBar
                      stars={stars}
      ...
      {/* Sort & Filter Bar */}
      {!compact && (
        <div className="px-4 sm:px-6 py-3 border-t border-b border-gray-100 flex items-center justify-between">
