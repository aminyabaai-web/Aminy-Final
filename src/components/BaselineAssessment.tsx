            ...
            {step === 'intro' && (
              <motion.div key="intro" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #2A7D99 0%, #376E80 100%)' }}
                >
                  Let's do it
                </button>
                  ...
                  {[1, 2, 3, 4, 5].map(v => (
                    <button
                      ...
                      className={`flex-1 aspect-square rounded-xl border text-sm font-semibold transition-all ${
                        intensity === v
                          ? 'border-[#2A7D99] bg-[#2A7D99]/10 text-[#2A7D99]'
                          : 'border-[#E8E4DF] text-[#3A4A57] hover:border-[#2A7D99] hover:bg-[#2A7D99]/5'
                      }`}
                    >
                      {v}
                    </button>
            ...
            {step === 'done' && (
              <motion.div key="done" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-4 text-center">
                <motion.div
                  ...
                  className="w-16 h-16 rounded-2xl bg-[#2A7D99]/10 flex items-center justify-center mx-auto mb-4"
                >
