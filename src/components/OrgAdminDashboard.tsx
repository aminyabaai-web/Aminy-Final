      ...
      <div className="min-h-screen bg-mist flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-6 text-center">
          <div className="max-w-sm">
            <div className="w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #4E93A8 0%, #7BA7BC 100%)' }}>
        ...
        <div className="mx-4 mt-4 rounded-2xl bg-white border border-[#E8E4DF] p-4">
          ...
          {org.subscriptionStatus === 'inactive' && (
            <div className="mt-4 pt-4 border-t border-[#E8E4DF] flex gap-2">
              <button onClick={() => handleStartCheckout('month')} className="flex-1 text-sm font-semibold py-2.5 rounded-xl text-white" style={{ background: 'linear-gradient(135deg, #4E93A8 0%, #7BA7BC 100%)' }}>
                Start Monthly
              </button>
          ...
          <div className="mt-3 h-2 bg-[#F0EDE8] rounded-full overflow-hidden">
            <div
              ...
              style={{
                ...
                background: usage.seatsAvailable === 0 ? '#E07A5F' : 'linear-gradient(90deg, #4E93A8 0%, #7BA7BC 100%)',
              }}
            />
          </div>
      ...
      <div className="mx-4 mt-3 rounded-2xl bg-white border border-[#E8E4DF]">
        <div className="px-4 pt-3 pb-2 flex items-center justify-between border-b border-[#E8E4DF]">
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #4E93A8 0%, #7BA7BC 100%)', color: 'white' }}
          >
