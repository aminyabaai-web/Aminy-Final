      ...
      <div className="px-4 py-3">
        <div className="flex items-start justify-between gap-2 mb-2">
          <div className="flex items-center gap-2">
            <span className="font-mono font-semibold text-sm text-[#132F43]">{line.procedureCode}</span>
      ...
      <Card className="p-5 rounded-2xl border-0 shadow-sm bg-white">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-semibold text-[#132F43] text-sm leading-tight">ERA Remittance</h2>
