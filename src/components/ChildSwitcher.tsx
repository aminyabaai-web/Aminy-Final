...
export function ChildSwitcher({
  ...
  if (children.length === 0) {
    return (
      <div className="p-6 text-center border border-[#E8E4DF] rounded-lg bg-[#F6FBFB]">
  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 p-2 rounded-lg hover:bg-[#EDF4F7] transition-colors w-full"
      >
          ...
          <div className="max-h-64 overflow-y-auto">
            {children.map((child) => (
              <button
                ...
                className="w-full p-3 flex items-center gap-3 hover:bg-[#F6FBFB] transition-colors"
              >
