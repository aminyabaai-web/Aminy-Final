          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 rounded-lg border border-[#E8E4DF] text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
              />
              <button
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#E8E4DF] bg-[#FAF7F2]">
          ...
          <div className="flex items-center gap-2">
            ...
            {onClose && (
              <button
                onClick={onClose}
                className="w-7 h-7 rounded-full flex items-center justify-center hover:bg-[#E8E4DF] transition-colors"
              >
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-2">
          ...
          {participants.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-[#5A6B7A]">No participants yet</p>
            </div>
          )}
        </div>
