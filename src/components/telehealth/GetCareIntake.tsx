        ...
        <section className="bg-white rounded-2xl p-4 border border-gray-100">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#577590]/20 focus:border-[#577590] transition-all"
            />
          </div>
        ...
        <section className="bg-white rounded-2xl p-4 border border-gray-100">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="w-full pl-10 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl text-left text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#577590]/20 focus:border-[#577590] transition-all"
            >
              ...
              <div className="absolute z-20 top-full left-0 right-0 mt-2 bg-white rounded-xl border border-gray-200 shadow-lg max-h-64 overflow-hidden">
                <div className="p-2 border-b border-gray-100">
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#577590]/20"
                    autoFocus
                  />
                </div>
                  ...
                  {filteredStates.map((state) => (
                    <button
                      ...
                      className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-50 transition-colors ${
                        userState === state.code ? 'bg-[#577590]/10 text-[#577590] font-medium' : 'text-gray-700'
                      }`}
                    >
                      {state.name}
                    </button>
          ...
          <div className="mt-3">
            <input
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#577590]/20 focus:border-[#577590] transition-all"
            />
          </div>
        </section>
  ...
  return (
    <button
      ...
      className={`flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all ${
        selected
          ? 'bg-[#577590]/10 border-[#577590] text-[#577590]'
