...
export function TelehealthHome({
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(180deg, #f7fbfb 0%, #f6faf8 40%, #eef4f8 100%)' }}
    >
      {/* Header */}
      ...
      <div className="px-4 py-6 pb-24 space-y-3 sm:space-y-4 sm:space-y-6">
        {/* Greeting */}
        <div className="rounded-[28px] border border-white/80 bg-[linear-gradient(135deg,rgba(255,255,255,0.96),rgba(240,249,249,0.95),rgba(235,246,250,0.96))] p-5 shadow-[0_24px_50px_rgba(15,23,42,0.08)]">
