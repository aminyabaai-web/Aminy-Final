      ...
      <div className="px-4 py-6 pb-24 space-y-3 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <button
            ...
            className="bg-white/90 rounded-2xl border border-[#E8E4DF] p-4 text-left shadow-sm hover:shadow-md hover:border-[#6B9080] transition-all"
          >
          ...
          <button
            ...
            className="bg-white rounded-2xl border border-[#E8E4DF] p-4 text-left hover:shadow-md hover:border-[#6B9080]/30 transition-all"
          >
            <div className="w-12 h-12 bg-[#6B9080]/10 rounded-full flex items-center justify-center mb-3">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2 -mx-4 px-4 scrollbar-hide">
            {featuredConcerns.map((concern) => (
              <button
                ...
                className="flex w-40 flex-shrink-0 flex-col rounded-2xl border border-[#E8E4DF] bg-white/95 p-4 text-left shadow-sm transition-all hover:-translate-y-0.5 hover:border-[#6B9080]/30 hover:shadow-md"
              >
            ...
            <div className="space-y-3">
              {featuredProviders.map((provider) => (
                <button
                  key={provider.id}
                  onClick={() => startFlow('browse-concerns')}
                  className="w-full bg-white rounded-xl border border-[#E8E4DF] p-4 text-left hover:shadow-md hover:border-[#6B9080]/30 transition-all"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <ChevronRight className="w-5 h-5 text-[#8A9BA8]" />
                  </div>
                </button>
              ))}
            </div>
