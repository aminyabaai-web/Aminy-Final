    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50 via-white to-gray-50">
      ...
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur-md border-b border-gray-100 px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base font-semibold text-gray-900">Finding Your Match</h1>
        </div>
      </div>
      ...
      <div className="px-4 pb-10 space-y-6 pt-6">
        ...
        >
          <h3 className="text-sm font-bold text-gray-800 mb-3">While we search for you</h3>
            ...
            <>
              ...
              <label className="flex items-center gap-2.5 cursor-pointer">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm text-gray-700">Also text me (number on file)</span>
                </div>
              </label>
