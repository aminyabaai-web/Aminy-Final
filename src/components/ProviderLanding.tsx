...
export function ProviderLanding({ onApply, onLogin, onBack }: ProviderLandingProps) {
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 overflow-y-auto">
      ...
      <header className="bg-white dark:bg-slate-900 border-b border-neutral-200 dark:border-slate-700 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" className="bg-teal-600 hover:bg-teal-700 text-xs sm:text-sm px-3 sm:px-4" onClick={onApply}>
              Apply Now
            </Button>
          </div>
        </div>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-teal-50 to-white dark:from-slate-800 dark:to-slate-900 py-10 sm:py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <Badge className="bg-teal-100 text-teal-700 mb-3 sm:mb-4 text-xs sm:text-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6 sm:mt-8">
                <Button
                  size="lg"
                  className="bg-teal-600 hover:bg-teal-700 text-base sm:text-lg px-6 sm:px-8 w-full sm:w-auto"
                  onClick={onApply}
                >
                  Apply to Join
            ...
            <div className="relative hidden sm:block">
              <Card className="p-5 sm:p-6 bg-white dark:bg-slate-800 shadow-xl">
                <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div>
                    <h3 className="font-semibold text-neutral-900 dark:text-white text-sm sm:text-base">Dr. Sarah Mitchell</h3>
                    <p className="text-neutral-500 dark:text-slate-400 text-xs sm:text-sm">BCBA, LBA</p>
                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="text-center p-2 sm:p-3 bg-neutral-50 dark:bg-slate-700 rounded-lg">
                    <p className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">42</p>
                    <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-slate-400">Active Clients</p>
                  </div>
                  <div className="text-center p-2 sm:p-3 bg-neutral-50 dark:bg-slate-700 rounded-lg">
                    <p className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">$8.2k</p>
                    <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-slate-400">This Month</p>
                  </div>
                  <div className="text-center p-2 sm:p-3 bg-neutral-50 dark:bg-slate-700 rounded-lg">
                    <p className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white">98%</p>
                    <p className="text-[10px] sm:text-xs text-neutral-500 dark:text-slate-400">Satisfaction</p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
            {[
              ...
              <Card key={title} className="p-3 sm:p-5 text-center hover:shadow-md transition-shadow">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center mx-auto mb-2 sm:mb-3">
                ...
                <p className="text-xs sm:text-sm text-neutral-500 dark:text-slate-400 mt-1 hidden sm:block">{desc}</p>
              </Card>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <Card
                key={title}
                className={`p-4 sm:p-6 ${highlight ? 'bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border-teal-200 dark:border-teal-800' : ''}`}
              >
                ...
                <h3 className="font-semibold text-neutral-900 dark:text-white mb-1 sm:mb-2 text-sm sm:text-base">{title}</h3>
          ...
          <div className="flex flex-col gap-6 sm:hidden max-w-sm mx-auto">
            {[
              ...
              <div key={title} className="flex items-start gap-4">
                ...
                <div className="pt-1">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-medium text-teal-600 bg-teal-50 dark:bg-teal-900/30 rounded-full px-2 py-0.5">Step {index + 1}</span>
                  </div>
                  <h3 className="font-semibold text-neutral-900 dark:text-white mt-1">{title}</h3>
      ...
      {/* Earnings Calculator */}
      <section className="py-10 sm:py-16 bg-gradient-to-br from-teal-600 to-cyan-600">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <Card className="p-4 sm:p-6 bg-white dark:bg-slate-800 max-w-lg mx-auto">
            <h3 className="font-semibold text-neutral-900 dark:text-white mb-3 sm:mb-4 text-center text-sm sm:text-base">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex justify-between p-3 sm:p-4 bg-teal-50 dark:bg-teal-900/30 rounded-lg border-2 border-teal-200 dark:border-teal-700">
                <span className="font-semibold text-teal-800 dark:text-teal-300 text-sm sm:text-base">Weekly Earnings</span>
                <span className="text-lg sm:text-xl font-bold text-teal-700 dark:text-teal-400">$2,250</span>
              </div>
            ...
            {[
              ...
              <Card key={i} className="p-4 sm:p-6">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-white text-xs sm:text-sm font-semibold flex-shrink-0">
                    {testimonial.name.split(' ').map(n => n[0]).join('')}
                  </div>
                  <div>
                    <p className="font-medium text-neutral-900 dark:text-white text-sm">{testimonial.name}</p>
                    <p className="text-xs sm:text-sm text-neutral-500 dark:text-slate-400">{testimonial.role}</p>
                  </div>
                </div>
              </Card>
            ))}
      ...
      <footer className="bg-neutral-900 dark:bg-slate-900 border-t border-neutral-800 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between mb-4 sm:mb-6">
            ...
            <div className="flex gap-4 sm:gap-6 text-xs sm:text-sm text-neutral-500">
