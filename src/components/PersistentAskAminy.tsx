        ...
        {!isMinimized && (
          <>
                ...
                <div className="space-y-3 sm:space-y-4 sm:space-y-6 py-4">
                  ...
                  {isTyping && (
                    <div className="flex gap-3">
                      ...
                      <div className="bg-[#F0EDE8] dark:bg-gray-800 rounded-2xl px-4 py-3 border border-gray-200 dark:border-gray-700">
                        <div className="flex items-center gap-2">
                          <div className="flex space-x-1">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
              <div className="relative bg-[#FAF7F2] dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 focus-within:border-accent focus-within:ring-2 focus-within:ring-accent/20 transition-all aminy-ai-card">
                <textarea
                  ref={textareaRef}
                  value={input}
