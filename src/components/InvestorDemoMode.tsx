  ...
  if (minimized) {
    return (
      <motion.button
        ...
        className="fixed bottom-4 left-4 z-50 flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-[#43AA8B] to-[#577590] text-white rounded-full shadow-lg hover:shadow-xl transition-all"
      >
      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden">
        ...
        <div className="border-t border-slate-100 px-5 py-3 flex items-center justify-between">
          ...
          {stepIndex === DEMO_STEPS.length - 1 ? (
            <button
              onClick={onClose}
              className="flex items-center gap-1 text-sm font-semibold text-white bg-gradient-to-br from-[#43AA8B] to-[#577590] px-4 py-1.5 rounded-lg hover:opacity-90 transition-opacity"
            >
              Done
