  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
                      ...
                      <div className="divide-y">
                        {facts.map((fact, index) => (
                          <motion.div
                            ...
                            className="p-4 hover:bg-[#F6FBFB]/50 transition-colors group"
                          >
        ...
        >
          <div className="inline-flex items-center gap-2 text-sm text-muted-foreground bg-[#F6FBFB] px-4 py-2 rounded-full">
