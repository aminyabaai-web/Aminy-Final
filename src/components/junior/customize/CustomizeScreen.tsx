...
const BACKGROUNDS: {
  ...
  { id: 'ocean', label: 'Ocean', emoji: '🌊', gradient: 'linear-gradient(180deg, #2EC4B6 0%, #2A7D99 100%)' },
];
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: equipped ? '2px solid #2A7D99' : '2px solid #E0E0E0',
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {outfit.starCost > 0 && (
                          <p className="text-sm" style={{ color: locked ? '#999' : '#2A7D99' }}>
                            {locked ? <><Lock size={10} className="inline" /> {outfit.starCost} ⭐</> : 'Unlocked!'}
                          </p>
                        )}
                        {outfit.starCost === 0 && outfit.id !== 'none' && (
                          <p className="text-sm" style={{ color: '#2A7D99' }}>Free!</p>
                        )}
                      </div>
                      {equipped && <Check size={18} color="#2A7D99" />}
                    </button>
                  );
                })}
              </div>
                ...
                {BACKGROUNDS.map((b) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        border: selected ? '3px solid #2A7D99' : '3px solid transparent',
          ...
          {selectedSection === 'sound' && (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                >
                  {prefs.soundEffects ? <Volume2 size={24} color="#2A7D99" /> : <VolumeX size={24} color="#999" />}
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: prefs.soundEffects ? '#2A7D99' : '#ccc',
                ...
                <button
                  ...
                  style={{ backgroundColor: 'white', border: '2px solid #E0E0E0' }}
                >
                  <Music size={24} color={prefs.music ? '#2A7D99' : '#999'} />
                  <div className="flex-1 text-left">
                  ...
                  <div
                    className="w-12 h-7 rounded-full flex items-center transition-all px-0.5"
                    style={{
                      backgroundColor: prefs.music ? '#2A7D99' : '#ccc',
