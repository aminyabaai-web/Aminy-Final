...
`;
  ...
  const getStatusColor = (status: 'improved' | 'maintained' | 'needs_attention') => {
    switch (status) {
      ...
      case 'maintained': return 'text-blue-700 bg-blue-50 border-blue-200';
    ...
    <div className="space-y-3 sm:space-y-4 sm:space-y-6">
      ...
      <Card className="p-6 border-l-4 border-l-teal-500">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg text-slate-900">Monthly Session Credits</h3>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-slate-900">{credit.type}</span>
                </div>
      ...
      {/* Upcoming Sessions */}
      <div>
        <h3 className="font-semibold text-lg text-slate-900 mb-4">Upcoming Sessions</h3>
                ...
                <Card key={session.id} className="p-3 sm:p-4">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-slate-900">{session.provider}</h4>
      ...
      <div>
        <h3 className="font-semibold text-lg text-slate-900 mb-4">Session History & Notes</h3>
                ...
                return (
                  <Card key={session.id} className="p-4 sm:p-5 md:p-6">
                    ...
                    <div className="mb-4 p-3 bg-slate-50 rounded-lg">
                      <h5 className="text-sm font-medium text-slate-700 mb-2">Observations:</h5>
                    ...
                    {/* Progress Updates */}
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-slate-700 mb-2">Progress Updates:</h5>
                    ...
                    <div className="p-3 bg-teal-50 rounded-lg border border-teal-200">
                      <h5 className="text-sm font-medium text-teal-900 mb-2">Next Steps:</h5>
                      <ul className="space-y-1">
      ...
      <Dialog open={showScheduling} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-3 sm:space-y-4 sm:space-y-6 py-4">
            {/* Calendar */}
            <div>
              <Label className="text-sm text-slate-700 mb-2 block">Select Date</Label>
            ...
            {/* Time Selection */}
            <div>
              <Label className="text-sm text-slate-700 mb-2 block">Select Time</Label>
            ...
            {/* Provider Selection */}
            <div>
              <Label className="text-sm text-slate-700 mb-2 block">Select Provider</Label>
