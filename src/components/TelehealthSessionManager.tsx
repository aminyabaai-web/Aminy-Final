    ...
    <div className="space-y-3 sm:space-y-4 sm:space-y-6">
      ...
      <Card className="p-6 border-l-4 border-l-[#6B9080]">
        <div className="flex items-start justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg text-[#1B2733]">Monthly Session Credits</h3>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-[#1B2733]">{credit.type}</span>
                </div>
      ...
      {/* Upcoming Sessions */}
      <div>
        <h3 className="font-semibold text-lg text-[#1B2733] mb-4">Upcoming Sessions</h3>
                ...
                <Card key={session.id} className="p-3 sm:p-4">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-[#1B2733]">{session.provider}</h4>
      ...
      <div>
        <h3 className="font-semibold text-lg text-[#1B2733] mb-4">Session History & Notes</h3>
              ...
              .map((session) => {
                ...
                return (
                  <Card key={session.id} className="p-4 sm:p-5 md:p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h4 className="font-semibold text-[#1B2733] mb-1">
                          {notes.provider}
                        </h4>
                        <p className="text-sm text-[#5A6B7A]">
      ...
      <Dialog open={showScheduling} onOpenChange={(open) => {
        ...
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle className="text-[#1B2733]">
