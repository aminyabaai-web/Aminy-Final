    ...
    >
      ...
      >
        <div style={{ width: '100%', maxWidth: '620px', margin: '0 auto' }}>
          ...
          >
            One place for every kind of care your child needs — behavior therapy, speech, mental health — coordinated by an AI that actually knows your family. From finding the right provider to tracking progress to handling insurance.
          </motion.p>
