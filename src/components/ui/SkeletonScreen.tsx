...
export function DashboardSkeleton() {
  return (
    <div className="min-h-screen bg-gray-50 p-4 space-y-4" role="status" aria-label="Loading dashboard">
      {/* Header */}
...
export function CommunitySkeleton() {
  return (
    <div className="min-h-screen bg-gray-50 p-4 space-y-4" role="status" aria-label="Loading community">
      {/* Search bar */}
...
export function SettingsSkeleton() {
  return (
    <div className="min-h-screen bg-gray-50 p-4 space-y-4" role="status" aria-label="Loading settings">
...
export function GenericSkeleton() {
  return (
    <div className="min-h-screen bg-gray-50 p-4 space-y-4" role="status" aria-label="Loading">
