    ...
    if (!demo) {
        return (
            <div style={{ width: '100%', minHeight: '100vh', backgroundColor: '#111827', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', textAlign: 'center', ...fontSmoothing }}>
                ...
                <button
                    onClick={onLeave}
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', minHeight: '44px', padding: '12px 20px', borderRadius: '12px', border: 'none', backgroundColor: '#2A7D99', color: '#FFF', fontSize: '15px', fontWeight: 600, cursor: 'pointer' }}
                >
