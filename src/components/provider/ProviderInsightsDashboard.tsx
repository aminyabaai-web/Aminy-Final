              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-medium text-[#132F43] dark:text-white capitalize text-sm">
                      {category.replace('-', ' ')}
                    </span>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-[#132F43] dark:text-white">{data.goals}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-[#5A6B7A] dark:text-slate-400">Avg Progress</span>
                      <span className="font-medium text-[#132F43] dark:text-white">{data.avgProgress}%</span>
                    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-5 hover:shadow-md transition-shadow cursor-pointer group">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-[#132F43] dark:text-white group-hover:text-[#6B9080] transition-colors">
                Generate Report
              </h4>
              <p className="text-sm text-[#5A6B7A] dark:text-slate-400">
        ...
        <Card className="p-5 hover:shadow-md transition-shadow cursor-pointer group">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-[#132F43] dark:text-white group-hover:text-violet-600 transition-colors">
                Add New Goal
              </h4>
              <p className="text-sm text-[#5A6B7A] dark:text-slate-400">
        ...
        <Card className="p-5 hover:shadow-md transition-shadow cursor-pointer group">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="font-medium text-[#132F43] dark:text-white group-hover:text-amber-600 transition-colors">
                AI Recommendations
              </h4>
              <p className="text-sm text-[#5A6B7A] dark:text-slate-400">
