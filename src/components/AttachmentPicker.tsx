      ...
      >
        ...
        <div className="px-4 pb-8 space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 sm:gap-4 p-4 rounded-xl bg-[#F6FBFB] dark:bg-slate-800 hover:bg-[#EDF4F7] dark:hover:bg-slate-700 transition-colors"
          >
