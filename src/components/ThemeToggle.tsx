  ...
  return (
    <div className={`relative ${className}`}>
      <button
        ...
        className="w-full flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-lg border border-[#E8E4DF] dark:border-slate-600 hover:border-[#E8E4DF] dark:hover:border-slate-500 hover:bg-[#F6FBFB] dark:hover:bg-slate-700 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 group"
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 rounded-md text-sm transition-colors duration-150 ${
                      isSelected 
                        ...
                        : 'text-[#3A4A57] dark:text-slate-200 hover:bg-[#F6FBFB] dark:hover:bg-slate-700'
                    }`}
                    role="menuitemradio"
