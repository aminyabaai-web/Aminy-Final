...
- ✅ **make-server deployed (v163, July 2)** — wins-append verified live via functional probe July 3. ⚠️ CommunicationTemplates "Send SMS/Email" buttons are still UI STUBS (no network call) — do not claim provider ad-hoc messaging is live until wired to /notifications/sms + /email routes.
